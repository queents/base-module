<template>
        ...
        >
            <template #singleLabel="props">
                <div class="flex justify-start space-x-2">
                    <img
                        class="option__image w-8"
                        v-if="props.option.media"
                        :src="props.option.media"
                        alt="No Man’s Sky"
                    />
                    <span class="option__desc">
                        ...
                        <br />
                        <span
                            class="option__small text-sm text-gray-400"
    ...
    <div class="flex justify-between my-4" v-if="view === 'view'">
        ...
        <div>
            <p
                class="m-1 text-center bg-primary-600 text-white rounded-lg w-full"
