                ...
                >
                    ...
                    >
                        <button
                            v-if="item.sortable"
                            @click.prevent="
                                resourceStore.setDesc();
                                resourceStore.setOrderBy(item.name);
                                reload();
                            "
                            :class="{
                                'font-bold': resourceStore.orderBy == item.name,
                            }"
                        ...
                        >
                            <span v-if="resourceStore.orderBy == item.name">
            ...
            <tbody class="divide-y whitespace-nowrap">
                ...
                >
                    ...
                    <td
                        ...
                        :class="{
                            sorting: resourceStore.orderBy == item.field,
                        }"
                    >
