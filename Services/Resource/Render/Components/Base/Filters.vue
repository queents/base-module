    ...
    <div class="flex items-center justify-end w-full gap-2 md:max-w-md">
        ...
        >
            <button
                ...
                type="button"
                class="flex items-center border justify-center w-10 h-10 rounded-full hover:bg-gray-500/5 focus:outline-none filament-tables-icon-button text-primary-500 focus:bg-primary-500/10 hover:bg-gray-300/5 filament-tables-filters-trigger"
            >
        ...
        >
            <button
                @click.prevent="showRows = !showRows"
                type="button"
                class="flex items-center border justify-center w-10 h-10 rounded-full hover:bg-gray-500/5 focus:outline-none filament-tables-icon-button text-primary-500 focus:bg-primary-500/10 hover:bg-gray-300/5 filament-tables-filters-trigger"
            >
            ...
            <div
                v-show="showRows"
                class="absolute right-[45px] rtl:left-[45px] rtl:right-[auto] z-50 top-[50px] w-screen max-w-[15rem] mt-2 transition dark:text-white top-full rtl:right-auto rtl:left-0"
            >
                <div
